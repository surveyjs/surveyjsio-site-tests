...
fixture `toolbox_customization`
    .page `https://surveyjstest.azurewebsites.net/Examples/Builder?id=toolboxcustomization&theme=default`;
...
test('Check tabs', async t => {
    await t
        ...
        .expect(Selector('[name="content-js"][class^="tabs__tab-panel example-tab fade codesnippet tabs_"]').find('pre').withText('var creatorOptions').exists).eql(true)
