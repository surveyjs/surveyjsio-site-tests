...
test("Menu Examples test", async (t) => {
  ...
  const menuItems = Selector(".products-menu__item .popup-menu__item.popup-menu__item--active");
  const visiblePopup = Selector(".popup-menu--expanded .popup-menu-content").filterVisible();
  const visiblePopupItems = Selector(".popup-menu--expanded .popup-menu-content .popup-menu__item").filterVisible();
